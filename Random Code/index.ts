...
function getTIme(hours:number,minutes?:number):String{
    if (!hours){
        return `00:${minutes}`
    }
    if (!minutes){
...
let arrowfunction_getTIme = (hours:number,minutes?:number):String => {
    if (!hours){
        return `00:${minutes}`
    }
    if (!minutes){
...
let add_func = (num1:number,num2:number) => {
    return num1 + num2;
}
let add_func2 = (num1:number,num2:number) => num1 + num2;
